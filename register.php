...
$DOB =$_POST['DOB'];
$mysqlDate = date("Y-m-d H:i:s",strtotime($DOB));
...
$State=$_POST['State'];
$q="insert into vol (First_Name,Last_Name,DOB,Email_Id,password,Mobile_Number,Gender,Address,City,Pin_Code,State) values ('$First_Name','$Last_Name','$mysqlDate','$Email_Id','$password',$Mobile_Number,'$Gender','$Address','$City',$Pin_Code,'$State')";
...
<body>
        ...
        <nav class="navbar navbar-expand-lg " id="head1">
			...
			<h1 style="text-align:center;"><b>Thank You For Registering</b><h1>
			<br>
			
			
			
			<a href="login1.html"><button class="continue_bt" type="Submit" name="continue " >Continue to Login</button></a>
